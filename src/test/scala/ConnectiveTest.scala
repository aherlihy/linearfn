...
import linearfn.{RestrictedSelectable, Multiplicity, ops, restrictedReturn, unrestricted}
...
class ConnectiveTest extends FunSuite:
  ...
  test("POSITIVE: @restrictedReturn - can return tracked inner value with Linear") {
    ...
    val result = RestrictedSelectable.RestrictedFn.apply(Multiplicity.Affine)((q1, q2))(refs =>
  ...
  test("POSITIVE: @restrictedReturn - nested flatMaps track dependencies") {
    ...
    val result = RestrictedSelectable.RestrictedFn.apply(Multiplicity.Affine)((q1, q2, q3))(refs =>
  ...
  test("POSITIVE: @unrestricted - function not tracked") {
    ...
    val result = RestrictedSelectable.RestrictedFn.apply(Multiplicity.Affine)(Tuple1(q))(refs =>
  ...
  test("POSITIVE: @unrestricted with plain values - EmptyTuple doesn't affect dependencies") {
    ...
    val result = RestrictedSelectable.RestrictedFn.apply(Multiplicity.Affine)(Tuple1(ex))(refs =>
  ...
  test("POSITIVE: @unrestricted - mixing restricted and unrestricted params") {
    ...
    val result = RestrictedSelectable.RestrictedFn.apply(Multiplicity.Affine)((ex1, ex2))(refs =>
  ...
  test("POSITIVE: regular function param - implicit conversion wraps function") {
    ...
    val result = RestrictedSelectable.RestrictedFn.apply(Multiplicity.Affine)(Tuple1(q1))(refs =>
  ...
  test("COMPARISON: all three annotation types behave correctly") {
    ...
    val result1 = RestrictedSelectable.RestrictedFn.apply(Multiplicity.Affine)((q1, q2))(refs =>
      Tuple1(refs._1.flatMap((x: Int) => refs._2))
    )
    assertEquals(result1._1.data, List(100, 100))

    // @unrestricted: doesn't track anything
    val result2 = RestrictedSelectable.RestrictedFn.apply(Multiplicity.Affine)(Tuple1(q1))(refs =>
    ...
    val result3 = RestrictedSelectable.RestrictedFn.apply(Multiplicity.Affine)(Tuple1(q1))(refs =>
      Tuple1(refs._1.combine((x: Int) => TestQuery(List(x + 1000))))
    )
  ...
  test("@restrictedReturn + Linear: POSITIVE - used exactly once") {
    ...
    val result = RestrictedSelectable.RestrictedFn.apply(Multiplicity.Linear)((q1, q2, q3))(refs =>
      val combined = refs._1.flatMap(x => refs._2)
      (combined, refs._3)
    )
  ...
  test("@restrictedReturn + Linear: NEGATIVE - used zero times") {
    val obtained = compileErrors("""
      ...
      RestrictedSelectable.RestrictedFn.apply(Multiplicity.Linear)((q1, q2))(refs =>
  ...
  test("@restrictedReturn + Relevant: POSITIVE - used exactly once") {
    ...
    val result = RestrictedSelectable.RestrictedFn.apply(Multiplicity.Relevant)((q1, q2, q3))(refs =>
      val combined = refs._1.flatMap(x => refs._2)
      (combined, refs._3)
    )
  ...
  test("@restrictedReturn + Relevant: POSITIVE - used twice") {
    ...
    val result = RestrictedSelectable.RestrictedFn.apply(Multiplicity.Relevant)((q1, q2))(refs =>
  ...
  test("@restrictedReturn + Relevant: NEGATIVE - used zero times") {
    val obtained = compileErrors("""
      ...
      RestrictedSelectable.RestrictedFn.apply(Multiplicity.Relevant)((q1, q2))(refs =>
        val combined = refs._1.flatMap(x => TestQuery(List(x)))
        (combined, refs._1)
      )
    """)
  ...
  test("@unrestricted + Linear: POSITIVE - unrestricted param doesn't affect linearity") {
    ...
    val result = RestrictedSelectable.RestrictedFn.apply(Multiplicity.Linear)(Tuple1(q))(refs =>
  ...
  test("@unrestricted + Linear: POSITIVE - receiver still tracked with Linear") {
    ...
    val result = RestrictedSelectable.RestrictedFn.apply(Multiplicity.Linear)((q1, q2))(refs =>
  ...
  test("@unrestricted + Affine: NEGATIVE - cannot use receiver twice") {
    val obtained = compileErrors("""
      ...
      RestrictedSelectable.RestrictedFn.apply(Multiplicity.Affine)(Tuple1(q))(refs =>
        val mapped1 = refs._1.map((x: Int) => x * 2)
  ...
  test("@unrestricted + Relevant: POSITIVE - used exactly once") {
    ...
    val result = RestrictedSelectable.RestrictedFn.apply(Multiplicity.Relevant)(Tuple1(q))(refs =>
      val mapped = refs._1.map((x: Int) => x * 2)
      Tuple1(mapped)
    )
  ...
  test("Regular + Linear: POSITIVE - used exactly once") {
    ...
    val result = RestrictedSelectable.RestrictedFn.apply(Multiplicity.Linear)(Tuple1(q1))(refs =>
      val transformed = refs._1.combine((x: Int) => TestQuery(List(x * 2)))
      Tuple1(transformed)
    )
  ...
  test("Regular + Linear: NEGATIVE - used twice") {
    val obtained = compileErrors("""
      ...
      RestrictedSelectable.RestrictedFn.apply(Multiplicity.Linear)(Tuple1(q1))(refs =>
  ...
  test("Regular + Affine: NEGATIVE - used twice") {
    val obtained = compileErrors("""
      ...
      RestrictedSelectable.RestrictedFn.apply(Multiplicity.Affine)(Tuple1(q1))(refs =>
        val transformed1 = refs._1.combine((x: Int) => TestQuery(List(x * 2)))
        val transformed2 = refs._1.combine((x: Int) => TestQuery(List(x * 3)))
        (transformed1, transformed2)
      )
  ...
  test("Regular + Relevant: POSITIVE - used exactly once") {
    ...
    val result = RestrictedSelectable.RestrictedFn.apply(Multiplicity.Relevant)(Tuple1(q1))(refs =>
      val transformed = refs._1.combine((x: Int) => TestQuery(List(x * 2)))
      Tuple1(transformed)
    )
  ...
  test("@unrestricted parameter - passing field allows returning parent value") {
    ...
    val result = RestrictedSelectable.RestrictedFn.apply(Multiplicity.Affine)((ex1, ex2, ex3))(refs =>
  ...
  test("@unrestricted with plain String - EmptyTuple deps don't affect result") {
    ...
    val result = RestrictedSelectable.RestrictedFn.apply(Multiplicity.Affine)(Tuple1(ex))(refs =>
      ...
      Tuple1(v1)  // Result only depends on refs._1
    )
  ...
  test("complex: multiple @unrestricted params with mixed types") {
    ...
    val result = RestrictedSelectable.RestrictedFn.apply(Multiplicity.Affine)((ex1, ex2, ex3))(refs =>
      ...
      Tuple1(r)  // Result depends on refs._1, refs._2, refs._3 but NOT config
    )
  ...
  test("@unrestricted - using field as param and returning parent value") {
    ...
    val result = RestrictedSelectable.RestrictedFn.apply(Multiplicity.Affine)((ex1, ex2))(refs =>
      ...
      (v1, refs._2)  // Can return refs._2 because its field was @unrestricted!
    )
  ...
  test("@unrestricted - multiple unrestricted params can all be returned separately") {
    ...
    val result = RestrictedSelectable.RestrictedFn.apply(Multiplicity.Affine)((ex, config1, config2))(refs =>
  ...
  test("@unrestricted - complex mixed tracked and unrestricted params") {
    ...
    val result = RestrictedSelectable.RestrictedFn.apply(Multiplicity.Affine)((ex1, ex2, ex3, config))(refs =>
  ...
  test("@unrestricted - same param passed multiple times AND returned") {
    ...
    val result = RestrictedSelectable.RestrictedFn.apply(Multiplicity.Affine)((ex, config))(refs =>
